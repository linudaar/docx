...
// MarshalXMLEx marshals to XML
func (m *MyMarshalerTest) MarshalXMLEx(e *Encoder, start StartElement) error {
	_ = e.EncodeToken(start)
	_ = e.EncodeToken(CharData([]byte("hello world")))
...
func (m *MyMarshalerAttrTest) MarshalXMLAttrEx(name Name) (Attr, error) {
...
func TestDecodeEncode(t *testing.T) {
	...
	_, _ = in.WriteString(`<?xml version="1.0" encoding="UTF-8"?>
<?Target Instruction?>
<root>
</root>
`)
